...
const Nav = () => {
  return (
    <>
    <div className='dark:bg-gray-800  w-screen h-[150px] flex lg:gap-70 gap-19 bg-[#FFE1DE] border-b-2 justify-center items-center px-10 '>
        <Image src={logo} alt="" width={100} height={82} className='w-[100px] h-[82px]' />
        <Image src={hairways} alt="" width={432.44} height={82} className='lg:w-[432.44px] h-[94px] sm:w-[242px] ' />
